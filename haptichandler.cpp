...
void HapticHandler::createEffects()
{
    ...
    {
        qDebug() << "===> Loading scene_1 successful ";
    }
    ...
    {
        qDebug() << "===> Loading scene_2 successful ";
    }
    ...
    {
        qDebug() << "===> Loading scene_3 successful ";
    }
    ...
    {
        qDebug() << "===> Loading scene_4 successful ";
    }
    ...
    {
        qDebug() << "===> Loading down_wall successful ";
    }
    ...
    {
        qDebug() << "===> Loading up_wall successful ";
    }
    ...
    {
        qDebug() << "===> Loading right_wall successful ";
    }
    ...
    {
        qDebug() << "===> Loading left_wall successful ";
    }
    ...
    {
        qDebug() << "===> Loading scene_6 successful ";
    }
    ...
    {
        qDebug() << "===> Loading scene_7 successful ";
    }
}
